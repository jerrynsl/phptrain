...
$result=$mysqli->query($query); 
	  if ($result){		  
		  echo '<div style="background-color: green; color: white; text-align: center; padding: 10px;">Record succesful</div>';
	  }
  }else{
  		echo '<div style="background-color: red; color: white; text-align: center; padding: 10px;">'.$error.'</div>';
  }
}
...
<body background="img/bgtrain.gif">
	...
	<img src="img/Chino.png">
		<form method="post" action="oof.php">
			<h1 class="head">Register Form</h1>
		<div>
			<p>First Name<br>
			<input type="text" value="<?php echo $firstname;?>"placeholder="Enter Your First Name"/>
			</p>	
		</div>
